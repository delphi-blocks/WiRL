...
begin
  ...
  FServer
    ...
    .AddApplication('/app')
      ...
      .Plugin.Configure<IWiRLMetricsSetting>
        .InMemoryStorage()
        //.SetMetricStorage(TRedisStorage)
        .EnableMetric(MetricAll) // num of thread, num of connection,
        .AddCustomMetric('request_time', 'Tempo di esecuzione della richiesta')
        .BackToApp

      .Plugin.Configure<IWiRLPrometheusSetting>
        .SetEnabled(True)
        //.AddMetric('request_time', TWiRLPrometeusMetricKind.Gauge)
        .BackToApp
