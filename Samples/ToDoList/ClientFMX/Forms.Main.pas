...
type
  TMainForm = class(TForm)
    ...
    procedure ItemsListViewItemClick(const Sender: TObject; const AItem:
        TListViewItem);
...
procedure TMainForm.ItemsListViewItemClick(const Sender: TObject; const AItem: TListViewItem);
begin
...
begin
  TodoDM.Update(CurrentID, Memo1.Text,
    procedure
    begin
      RefreshList;
    end
