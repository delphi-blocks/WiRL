...
{   cmd /C ""WiRL_Setup.exe"                                             }
{     /DIR="C:\Dev\WiRL" /SILENT                                         }
{     /RADStudioVersions=all"                                            }
{                                                                        }
{ In GetIt implementation, the installation command could be:            }
{   cmd /C ""$(BDSCatalogRepository)\WiRL\                               }
{     WiRL_Setup.exe"                                                    }
{     /DIR="$(BDSCatalogRepository)\WiRL" /VERYSILENT                    }
{     /RADStudioVersions=$(ProductVersion) /CreateUninstallRegKey=no"    }
{                                                                        }
{ Example of command line to uninstall in silent mode:                   }
{   cmd /C ""C:\$(UserDocs)WiRL\unins000.exe" /VERYSILENT                }
{     /RADStudioVersions=all"                                            }
{                                                                        }
{ In GetIt implementation, the uninstall command could be:               }
{   cmd /C ""$(BDSCatalogRepository)\WiRL\unins000.exe"                  }
{     /VERYSILENT /RADStudioVersions=$(ProductVersion)"                  }
{                                                                        }
{************************************************************************}

#define LibraryName "WiRL"
#define SetupName "WiRL"
#define LibraryVersion "4.6.0"
#define LibraryPublisher "WiRL Team"
#define LibraryCopyright "Copyright (c) 2015-2025 WiRL Team"
#define LibraryURL "https://wirl.delphiblocks.dev/"
...
#define LibraryDocumentationURL "https://wirl.delphiblocks.dev/"
#define LibrarySupportURL "https://github.com/delphi-blocks/WiRL/issues/"
#define LibraryUpdatesURL "https://github.com/delphi-blocks/WiRL/releases/"
#define LibraryLicenseFileName "..\LICENSE"
#define BannerImagesFileName "WizWiRLImage*.bmp"
#define SmallImagesFileName "WizWiRLSmallImage*.bmp"
...
AppId={{2481317C-D923-4E4E-8ED0-9BD09335AAF8}
AppName={#LibraryName}
...
; Custom files:
;Source: "..\{#LibraryPackagesFolder}\WiRLSplash.res"; DestDir: "{app}\{#LibraryPackagesFolder}"; Flags: recursesubdirs ignoreversion
...
Type: filesandordirs; Name: "{app}\AllPackages\*";
...
Type: dirifempty; Name: "{app}\Libs";
Type: dirifempty; Name: "{app}\Packages";
Type: dirifempty; Name: "{app}\AllPackages";
